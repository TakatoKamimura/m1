...
# CSVファイルを読み込み
df = pd.read_csv('textchat_from_youtube\\lYJE1CBf_2o_37kuzuha_kirinukich_Wrim無し統合_batch8_val改善_使うやつ _開始40分.csv')
...
# テキストファイルに書き込み
with open("lYJE1CBf_2o_37kuzuha_kirinukich_Wrim無し統合_batch8_val改善_使うやつ _開始40分.txt", "w") as file:
    file.write(list_as_string)
print(total_length)
a=[]
for i,v in enumerate(section):
